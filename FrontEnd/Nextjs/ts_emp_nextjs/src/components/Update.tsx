...
import {EmployeeInfo, handleUpdateEmployee} from "@/redux/slice/employeeSlice";
import {useDispatch, useSelector} from "react-redux";
import {RootDispatch, RootState} from "@/redux/employStore";
import {putEmployeeInfoById} from "@/redux/api/employeeAPI";
...
const Update = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>)=> {
        e.preventDefault();
        dispatch(putEmployeeInfoById(infoToUpdate));
