...
import {EmployeeInfo, handleSelectedId} from "@/redux/slice/employeeSlice";
import {fetchEmployeeInfoList} from "@/redux/api/employeeAPI";
...
const EmployeeList = () => {
    ...
    useEffect(() => {
        dispatch(fetchEmployeeInfoList())
    }, [dispatch]);
